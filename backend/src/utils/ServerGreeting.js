...
GET ${this.config.apiURIPrefix}/ГГГГ-ММ-ДД - получить расписание киносеансов на дату ДД.ММ.ГГГГ
...
POST ${this.config.apiURIPrefix}/booking/{id} - создать новое бронирование для киносеанса с ID = {id}
`;
	}
}
